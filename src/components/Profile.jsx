...
import { Card, CardBody, CardHeader, Avatar, Divider, Spinner, Button } from "@nextui-org/react";
        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-purple-100 to-pink-100 p-4">
            <Card className="max-w-[700px] w-full">
                <CardHeader className="flex gap-3">
                    <Avatar src={user.avatar || "https://i.pravatar.cc/150?u=a042581f4e29026024d"} size="lg" />
                    <div className="flex flex-col">
                        <p className="text-md">Profile</p>
                        <p className="text-small text-default-500">Welcome back, {user.name}!</p>
                    </div>
                </CardHeader>
                <Divider/>
                <CardBody>
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-md">{new Date(user.createdAt).toLocaleDateString()}</p>
                            </div>
                        </div>
                        {user.bio && (
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <p className="text-small text-default-500">Bio</p>
